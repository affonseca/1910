package com.mobilelearning.game1910.serviceHandling.SSLv3Fix;
...
public class MyNetJavaImpl {
    ...
    public MyNetJavaImpl() {
        ...
        try{
            ...
            SSLSocketFactory NoSSLv3Factory = new com.mobilelearning.game1910.serviceHandling.SSLv3Fix.NoSSLv3SocketFactory(sslcontext.getSocketFactory());
